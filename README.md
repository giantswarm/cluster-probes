...
# cluster-probes chart

Giant Swarm offers a cluster-probes App which can be installed in workload clusters.
Here, we define the cluster-probes chart with its templates and default configuration.
